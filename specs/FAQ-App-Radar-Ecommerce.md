...
- **Estorno de pedido cancelado (correção 2026-07-24):** o estorno **não depende de quem cancela** (Portal ou ERP) — depende da modalidade de pagamento. Offline (maquininha): não há estorno, pois nunca foi pago antes. Online por crédito: estorno automático pela Braspag, valor integral. Online por Pix: estorno automático **só se houver saldo na conta Cielo** — a Cielo transfere automaticamente o saldo recebido pra outra conta da loja por padrão (configurável em até 4 horários fixos no portal da Cielo), então um cancelamento após essa transferência exige estorno manual. Isso substitui a nota anterior deste ponto (que dizia que cancelamento pela loja nunca tinha estorno automatizado — incompleto).
- **Relação Braspag/Cielo (correção 2026-07-24):** a seção "Checkout — pagamento" descreve Braspag e Cielo como integrações **separadas, em migração** ("separada da antiga integração E-Commerce com a Cielo — migração em andamento"). Segundo o time de Portal, isso está desatualizado: são **camadas da mesma contratação** — o associado contrata pagamento online (cartão) com a Braspag; se quiser Pix também, a contratação continua sendo com a Braspag, mas quem efetivamente opera o Pix é a Cielo. Não são alternativas concorrentes.
